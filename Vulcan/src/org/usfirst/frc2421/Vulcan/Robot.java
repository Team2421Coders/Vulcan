...
public class Robot extends IterativeRobot {
    ...
    RobotMap.init();
		...
		System.out.println("camera 0 set mode " + camera.setVideoMode(PixelFormat.kMJPEG, 640, 480, 20));
		camera.setExposureManual(20);
		//camera.setFPS(8);
		//camera.setResolution(640, 480);
		camera2 = CameraServer.getInstance().startAutomaticCapture(1);
		camera2.setVideoMode(PixelFormat.kMJPEG, 160, 120, 8);
