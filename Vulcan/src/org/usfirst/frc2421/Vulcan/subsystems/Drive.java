...
public class Drive extends Subsystem {
	...
	static double backSpeedMult = 0.2;
    ...
    public static void setLeft(double x){
    	if (x < 0)//negative
    	{
    	driveLeft1.set(-x*backSpeedMult);
    	driveLeft2.set(-x*backSpeedMult);
    	}
    	else
    	{
    ...
    public static void setRight(double x){
    	if (x < 0)
    	{
    	driveRight1.set(-x*backSpeedMult);
    	driveRight2.set(-x*backSpeedMult);
    	}
    	else
    	{
