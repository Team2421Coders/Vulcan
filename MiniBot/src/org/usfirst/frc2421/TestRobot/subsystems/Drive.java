...
package org.usfirst.frc2421.TestRobot.subsystems;

import org.usfirst.frc2421.TestRobot.RobotMap;
...
public class Drive extends Subsystem {
    ...
    public static void setLeft(double x){
    	System.out.println("set speed left: " + x);
    	driveLeft1.set(x*speedMult);
    	driveLeft2.set(x*speedMult);
    }
    public static void setRight(double x){
    	System.out.println("set speed right: " + x);
    	driveRight1.set(-x*speedMult*.9);
    	driveRight2.set(-x*speedMult*.9);
    }
}
